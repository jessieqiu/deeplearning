...
def getGradient(a1, z2, a2, previous_dldz, w, activation_function,alp,mask,keep_prob=0.5):
    dzda = w 
    
    dadz = getActivationFunctionDerivative(a2,z2,activation_function,alp)
    dadz = np.multiply(mask,dadz)
    dadz = dadz/keep_prob
...
for i in range(max_iterations):
    ...
    # X is training data
    z1,a1,z2,a2,_,a3,D1,D2 = forward_all_layers(np.transpose(X),weights_1, bias_1, weights_2,bias_2,weights_3,bias_3, activations,alphas)
    ...
    dldz_2, dldw_2, dldb_2 = getGradient(a1, z2, a2, dldz_3, weights_3, activations[-2],alphas[-2], D2, keep_prob_2) 

    dldz_1, dldw_1, dldb_1 = getGradient(X.T, z1, a1, dldz_2, weights_2, activations[-3],alphas[-3], D1, keep_prob_1) 
